...
// Wed Nov 22 09:32:41 2023 by ROOT version 6.28/04
// from TTree DecayTree/DecayTree
// found on file: 2012UpAll.root
//////////////////////////////////////////////////////////

#ifndef ZDecayToMuonManyAttributes_h
#define ZDecayToMuonManyAttributes_h
...
class ZDecayToMuonManyAttributes {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ZDecayToMuonManyAttributes(TTree *tree=0);
   virtual ~ZDecayToMuonManyAttributes();
...
#ifdef ZDecayToMuonManyAttributes_cxx
ZDecayToMuonManyAttributes::ZDecayToMuonManyAttributes(TTree *tree) : fChain(0) 
{
...
ZDecayToMuonManyAttributes::~ZDecayToMuonManyAttributes()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ZDecayToMuonManyAttributes::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ZDecayToMuonManyAttributes::LoadTree(Long64_t entry)
{
...
void ZDecayToMuonManyAttributes::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("muon1_MC12TuneV2_ProbNNe", &muon1_MC12TuneV2_ProbNNe, &b_muon1_MC12TuneV2_ProbNNe);
   fChain->SetBranchAddress("muon1_MC12TuneV2_ProbNNmu", &muon1_MC12TuneV2_ProbNNmu, &b_muon1_MC12TuneV2_ProbNNmu);
   fChain->SetBranchAddress("muon1_MC12TuneV2_ProbNNpi", &muon1_MC12TuneV2_ProbNNpi, &b_muon1_MC12TuneV2_ProbNNpi);
   fChain->SetBranchAddress("muon1_MC12TuneV2_ProbNNk", &muon1_MC12TuneV2_ProbNNk, &b_muon1_MC12TuneV2_ProbNNk);
   fChain->SetBranchAddress("muon1_MC12TuneV2_ProbNNp", &muon1_MC12TuneV2_ProbNNp, &b_muon1_MC12TuneV2_ProbNNp);
   fChain->SetBranchAddress("muon1_MC12TuneV2_ProbNNghost", &muon1_MC12TuneV2_ProbNNghost, &b_muon1_MC12TuneV2_ProbNNghost);
   fChain->SetBranchAddress("muon1_MC12TuneV3_ProbNNe", &muon1_MC12TuneV3_ProbNNe, &b_muon1_MC12TuneV3_ProbNNe);
   fChain->SetBranchAddress("muon1_MC12TuneV3_ProbNNmu", &muon1_MC12TuneV3_ProbNNmu, &b_muon1_MC12TuneV3_ProbNNmu);
   fChain->SetBranchAddress("muon1_MC12TuneV3_ProbNNpi", &muon1_MC12TuneV3_ProbNNpi, &b_muon1_MC12TuneV3_ProbNNpi);
   fChain->SetBranchAddress("muon1_MC12TuneV3_ProbNNk", &muon1_MC12TuneV3_ProbNNk, &b_muon1_MC12TuneV3_ProbNNk);
   fChain->SetBranchAddress("muon1_MC12TuneV3_ProbNNp", &muon1_MC12TuneV3_ProbNNp, &b_muon1_MC12TuneV3_ProbNNp);
   fChain->SetBranchAddress("muon1_MC12TuneV3_ProbNNghost", &muon1_MC12TuneV3_ProbNNghost, &b_muon1_MC12TuneV3_ProbNNghost);
   fChain->SetBranchAddress("muon1_MC12TuneV4_ProbNNe", &muon1_MC12TuneV4_ProbNNe, &b_muon1_MC12TuneV4_ProbNNe);
   fChain->SetBranchAddress("muon1_MC12TuneV4_ProbNNmu", &muon1_MC12TuneV4_ProbNNmu, &b_muon1_MC12TuneV4_ProbNNmu);
   fChain->SetBranchAddress("muon1_MC12TuneV4_ProbNNpi", &muon1_MC12TuneV4_ProbNNpi, &b_muon1_MC12TuneV4_ProbNNpi);
   fChain->SetBranchAddress("muon1_MC12TuneV4_ProbNNk", &muon1_MC12TuneV4_ProbNNk, &b_muon1_MC12TuneV4_ProbNNk);
   fChain->SetBranchAddress("muon1_MC12TuneV4_ProbNNp", &muon1_MC12TuneV4_ProbNNp, &b_muon1_MC12TuneV4_ProbNNp);
   fChain->SetBranchAddress("muon1_MC12TuneV4_ProbNNghost", &muon1_MC12TuneV4_ProbNNghost, &b_muon1_MC12TuneV4_ProbNNghost);
   fChain->SetBranchAddress("muon1_MC15TuneV1_ProbNNe", &muon1_MC15TuneV1_ProbNNe, &b_muon1_MC15TuneV1_ProbNNe);
   fChain->SetBranchAddress("muon1_MC15TuneV1_ProbNNmu", &muon1_MC15TuneV1_ProbNNmu, &b_muon1_MC15TuneV1_ProbNNmu);
   fChain->SetBranchAddress("muon1_MC15TuneV1_ProbNNpi", &muon1_MC15TuneV1_ProbNNpi, &b_muon1_MC15TuneV1_ProbNNpi);
   fChain->SetBranchAddress("muon1_MC15TuneV1_ProbNNk", &muon1_MC15TuneV1_ProbNNk, &b_muon1_MC15TuneV1_ProbNNk);
   fChain->SetBranchAddress("muon1_MC15TuneV1_ProbNNp", &muon1_MC15TuneV1_ProbNNp, &b_muon1_MC15TuneV1_ProbNNp);
   fChain->SetBranchAddress("muon1_MC15TuneV1_ProbNNghost", &muon1_MC15TuneV1_ProbNNghost, &b_muon1_MC15TuneV1_ProbNNghost);
   ...
   fChain->SetBranchAddress("muon1_OWNPV_XERR", &muon1_OWNPV_XERR, &b_muon1_OWNPV_XERR);
   fChain->SetBranchAddress("muon1_OWNPV_YERR", &muon1_OWNPV_YERR, &b_muon1_OWNPV_YERR);
   fChain->SetBranchAddress("muon1_OWNPV_ZERR", &muon1_OWNPV_ZERR, &b_muon1_OWNPV_ZERR);
   fChain->SetBranchAddress("muon1_OWNPV_CHI2", &muon1_OWNPV_CHI2, &b_muon1_OWNPV_CHI2);
   fChain->SetBranchAddress("muon1_OWNPV_NDOF", &muon1_OWNPV_NDOF, &b_muon1_OWNPV_NDOF);
   fChain->SetBranchAddress("muon1_OWNPV_COV_", muon1_OWNPV_COV_, &b_muon1_OWNPV_COV_);
   fChain->SetBranchAddress("muon1_IP_OWNPV", &muon1_IP_OWNPV, &b_muon1_IP_OWNPV);
   fChain->SetBranchAddress("muon1_IPCHI2_OWNPV", &muon1_IPCHI2_OWNPV, &b_muon1_IPCHI2_OWNPV);
   ...
   fChain->SetBranchAddress("muon1_ORIVX_XERR", &muon1_ORIVX_XERR, &b_muon1_ORIVX_XERR);
   fChain->SetBranchAddress("muon1_ORIVX_YERR", &muon1_ORIVX_YERR, &b_muon1_ORIVX_YERR);
   fChain->SetBranchAddress("muon1_ORIVX_ZERR", &muon1_ORIVX_ZERR, &b_muon1_ORIVX_ZERR);
   fChain->SetBranchAddress("muon1_ORIVX_CHI2", &muon1_ORIVX_CHI2, &b_muon1_ORIVX_CHI2);
   fChain->SetBranchAddress("muon1_ORIVX_NDOF", &muon1_ORIVX_NDOF, &b_muon1_ORIVX_NDOF);
   fChain->SetBranchAddress("muon1_ORIVX_COV_", muon1_ORIVX_COV_, &b_muon1_ORIVX_COV_);
   ...
   fChain->SetBranchAddress("muon1_ProbNNpi", &muon1_ProbNNpi, &b_muon1_ProbNNpi);
   fChain->SetBranchAddress("muon1_ProbNNmu", &muon1_ProbNNmu, &b_muon1_ProbNNmu);
   fChain->SetBranchAddress("muon1_ProbNNd", &muon1_ProbNNd, &b_muon1_ProbNNd);
   fChain->SetBranchAddress("muon1_ProbNNghost", &muon1_ProbNNghost, &b_muon1_ProbNNghost);
   ...
   fChain->SetBranchAddress("muon1_UsedRichAerogel", &muon1_UsedRichAerogel, &b_muon1_UsedRichAerogel);
   fChain->SetBranchAddress("muon1_UsedRich1Gas", &muon1_UsedRich1Gas, &b_muon1_UsedRich1Gas);
   fChain->SetBranchAddress("muon1_UsedRich2Gas", &muon1_UsedRich2Gas, &b_muon1_UsedRich2Gas);
   fChain->SetBranchAddress("muon1_RichAboveElThres", &muon1_RichAboveElThres, &b_muon1_RichAboveElThres);
   fChain->SetBranchAddress("muon1_RichAboveMuThres", &muon1_RichAboveMuThres, &b_muon1_RichAboveMuThres);
   fChain->SetBranchAddress("muon1_RichAbovePiThres", &muon1_RichAbovePiThres, &b_muon1_RichAbovePiThres);
   fChain->SetBranchAddress("muon1_RichAboveKaThres", &muon1_RichAboveKaThres, &b_muon1_RichAboveKaThres);
   fChain->SetBranchAddress("muon1_RichAbovePrThres", &muon1_RichAbovePrThres, &b_muon1_RichAbovePrThres);
   fChain->SetBranchAddress("muon1_hasCalo", &muon1_hasCalo, &b_muon1_hasCalo);
   fChain->SetBranchAddress("muon2_MC12TuneV2_ProbNNe", &muon2_MC12TuneV2_ProbNNe, &b_muon2_MC12TuneV2_ProbNNe);
   fChain->SetBranchAddress("muon2_MC12TuneV2_ProbNNmu", &muon2_MC12TuneV2_ProbNNmu, &b_muon2_MC12TuneV2_ProbNNmu);
   fChain->SetBranchAddress("muon2_MC12TuneV2_ProbNNpi", &muon2_MC12TuneV2_ProbNNpi, &b_muon2_MC12TuneV2_ProbNNpi);
   fChain->SetBranchAddress("muon2_MC12TuneV2_ProbNNk", &muon2_MC12TuneV2_ProbNNk, &b_muon2_MC12TuneV2_ProbNNk);
   fChain->SetBranchAddress("muon2_MC12TuneV2_ProbNNp", &muon2_MC12TuneV2_ProbNNp, &b_muon2_MC12TuneV2_ProbNNp);
   fChain->SetBranchAddress("muon2_MC12TuneV2_ProbNNghost", &muon2_MC12TuneV2_ProbNNghost, &b_muon2_MC12TuneV2_ProbNNghost);
   fChain->SetBranchAddress("muon2_MC12TuneV3_ProbNNe", &muon2_MC12TuneV3_ProbNNe, &b_muon2_MC12TuneV3_ProbNNe);
   fChain->SetBranchAddress("muon2_MC12TuneV3_ProbNNmu", &muon2_MC12TuneV3_ProbNNmu, &b_muon2_MC12TuneV3_ProbNNmu);
   fChain->SetBranchAddress("muon2_MC12TuneV3_ProbNNpi", &muon2_MC12TuneV3_ProbNNpi, &b_muon2_MC12TuneV3_ProbNNpi);
   fChain->SetBranchAddress("muon2_MC12TuneV3_ProbNNk", &muon2_MC12TuneV3_ProbNNk, &b_muon2_MC12TuneV3_ProbNNk);
   fChain->SetBranchAddress("muon2_MC12TuneV3_ProbNNp", &muon2_MC12TuneV3_ProbNNp, &b_muon2_MC12TuneV3_ProbNNp);
   fChain->SetBranchAddress("muon2_MC12TuneV3_ProbNNghost", &muon2_MC12TuneV3_ProbNNghost, &b_muon2_MC12TuneV3_ProbNNghost);
   fChain->SetBranchAddress("muon2_MC12TuneV4_ProbNNe", &muon2_MC12TuneV4_ProbNNe, &b_muon2_MC12TuneV4_ProbNNe);
   fChain->SetBranchAddress("muon2_MC12TuneV4_ProbNNmu", &muon2_MC12TuneV4_ProbNNmu, &b_muon2_MC12TuneV4_ProbNNmu);
   fChain->SetBranchAddress("muon2_MC12TuneV4_ProbNNpi", &muon2_MC12TuneV4_ProbNNpi, &b_muon2_MC12TuneV4_ProbNNpi);
   fChain->SetBranchAddress("muon2_MC12TuneV4_ProbNNk", &muon2_MC12TuneV4_ProbNNk, &b_muon2_MC12TuneV4_ProbNNk);
   fChain->SetBranchAddress("muon2_MC12TuneV4_ProbNNp", &muon2_MC12TuneV4_ProbNNp, &b_muon2_MC12TuneV4_ProbNNp);
   fChain->SetBranchAddress("muon2_MC12TuneV4_ProbNNghost", &muon2_MC12TuneV4_ProbNNghost, &b_muon2_MC12TuneV4_ProbNNghost);
   fChain->SetBranchAddress("muon2_MC15TuneV1_ProbNNe", &muon2_MC15TuneV1_ProbNNe, &b_muon2_MC15TuneV1_ProbNNe);
   fChain->SetBranchAddress("muon2_MC15TuneV1_ProbNNmu", &muon2_MC15TuneV1_ProbNNmu, &b_muon2_MC15TuneV1_ProbNNmu);
   fChain->SetBranchAddress("muon2_MC15TuneV1_ProbNNpi", &muon2_MC15TuneV1_ProbNNpi, &b_muon2_MC15TuneV1_ProbNNpi);
   fChain->SetBranchAddress("muon2_MC15TuneV1_ProbNNk", &muon2_MC15TuneV1_ProbNNk, &b_muon2_MC15TuneV1_ProbNNk);
   fChain->SetBranchAddress("muon2_MC15TuneV1_ProbNNp", &muon2_MC15TuneV1_ProbNNp, &b_muon2_MC15TuneV1_ProbNNp);
   fChain->SetBranchAddress("muon2_MC15TuneV1_ProbNNghost", &muon2_MC15TuneV1_ProbNNghost, &b_muon2_MC15TuneV1_ProbNNghost);
   ...
   fChain->SetBranchAddress("muon2_OWNPV_XERR", &muon2_OWNPV_XERR, &b_muon2_OWNPV_XERR);
   fChain->SetBranchAddress("muon2_OWNPV_YERR", &muon2_OWNPV_YERR, &b_muon2_OWNPV_YERR);
   fChain->SetBranchAddress("muon2_OWNPV_ZERR", &muon2_OWNPV_ZERR, &b_muon2_OWNPV_ZERR);
   fChain->SetBranchAddress("muon2_OWNPV_CHI2", &muon2_OWNPV_CHI2, &b_muon2_OWNPV_CHI2);
   fChain->SetBranchAddress("muon2_OWNPV_NDOF", &muon2_OWNPV_NDOF, &b_muon2_OWNPV_NDOF);
   fChain->SetBranchAddress("muon2_OWNPV_COV_", muon2_OWNPV_COV_, &b_muon2_OWNPV_COV_);
   fChain->SetBranchAddress("muon2_IP_OWNPV", &muon2_IP_OWNPV, &b_muon2_IP_OWNPV);
   fChain->SetBranchAddress("muon2_IPCHI2_OWNPV", &muon2_IPCHI2_OWNPV, &b_muon2_IPCHI2_OWNPV);
   ...
   fChain->SetBranchAddress("muon2_ORIVX_XERR", &muon2_ORIVX_XERR, &b_muon2_ORIVX_XERR);
   fChain->SetBranchAddress("muon2_ORIVX_YERR", &muon2_ORIVX_YERR, &b_muon2_ORIVX_YERR);
   fChain->SetBranchAddress("muon2_ORIVX_ZERR", &muon2_ORIVX_ZERR, &b_muon2_ORIVX_ZERR);
   fChain->SetBranchAddress("muon2_ORIVX_CHI2", &muon2_ORIVX_CHI2, &b_muon2_ORIVX_CHI2);
   fChain->SetBranchAddress("muon2_ORIVX_NDOF", &muon2_ORIVX_NDOF, &b_muon2_ORIVX_NDOF);
   fChain->SetBranchAddress("muon2_ORIVX_COV_", muon2_ORIVX_COV_, &b_muon2_ORIVX_COV_);
   ...
   fChain->SetBranchAddress("muon2_ProbNNpi", &muon2_ProbNNpi, &b_muon2_ProbNNpi);
   fChain->SetBranchAddress("muon2_ProbNNmu", &muon2_ProbNNmu, &b_muon2_ProbNNmu);
   fChain->SetBranchAddress("muon2_ProbNNd", &muon2_ProbNNd, &b_muon2_ProbNNd);
   fChain->SetBranchAddress("muon2_ProbNNghost", &muon2_ProbNNghost, &b_muon2_ProbNNghost);
   ...
   fChain->SetBranchAddress("muon2_UsedRichAerogel", &muon2_UsedRichAerogel, &b_muon2_UsedRichAerogel);
   fChain->SetBranchAddress("muon2_UsedRich1Gas", &muon2_UsedRich1Gas, &b_muon2_UsedRich1Gas);
   fChain->SetBranchAddress("muon2_UsedRich2Gas", &muon2_UsedRich2Gas, &b_muon2_UsedRich2Gas);
   fChain->SetBranchAddress("muon2_RichAboveElThres", &muon2_RichAboveElThres, &b_muon2_RichAboveElThres);
   fChain->SetBranchAddress("muon2_RichAboveMuThres", &muon2_RichAboveMuThres, &b_muon2_RichAboveMuThres);
   fChain->SetBranchAddress("muon2_RichAbovePiThres", &muon2_RichAbovePiThres, &b_muon2_RichAbovePiThres);
   fChain->SetBranchAddress("muon2_RichAboveKaThres", &muon2_RichAboveKaThres, &b_muon2_RichAboveKaThres);
   fChain->SetBranchAddress("muon2_RichAbovePrThres", &muon2_RichAbovePrThres, &b_muon2_RichAbovePrThres);
...
Bool_t ZDecayToMuonManyAttributes::Notify()
{
...
void ZDecayToMuonManyAttributes::Show(Long64_t entry)
{
...
Int_t ZDecayToMuonManyAttributes::Cut(Long64_t entry)
{
...
#endif // #ifdef ZDecayToMuonManyAttributes_cxx
